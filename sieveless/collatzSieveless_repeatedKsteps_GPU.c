...
On Linux, compile via something like...
  clang -O3 collatzSieveless_repeatedKsteps_GPU.c -lOpenCL
...
next_platform:
  ...
  __uint128_t n0start = (__uint128_t)TASK_ID * arrayIncreasesCount + 3;  // for analyzing the results of kernel1
